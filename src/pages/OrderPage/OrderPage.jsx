...
import { decreaseAmount, increaseAmount, removeAllOrderProduct, removeOrderProduct, selectedOrder } from '../../redux/sliders/orderSlide';
import { convertPrice } from '../../ultils';
import { useNavigate } from 'react-router-dom';
import ModalComponent from './../../component/ModalComponent/ModalComponent';
import InputCompunent from './../../component/InputCompunent/InputCompunent';
...
const OrderPage = () => {
  ...
  const handleUpdateInforUser = () => {
    console.log('stateProductUserDetails', stateUserDetails)
          ...
          <WrapperLeft>
            ...
            <WrapperStyleHeader>
              <span style={{ display: 'inline-block', width: '390px' }}>
                <Checkbox onChange={handleChangeCheckAll} checked={listChecked?.length === order?.orderItems?.length} ></Checkbox>
      ...
      <ModalComponent title="Cập nhật thông tin giao hàng" open={isOpenModalUpdateInfo} onCancel={handleCancleUpdate} onOk={handleUpdateInforUser}>
        <Loading isLoading={isLoading}>
          ...
          >
            ...
            >
              <InputCompunent value={stateUserDetails['name']} onChange={handleOnchangeDetails} name="name" />
            </Form.Item>
            <Form.Item
              label="City"
              name="city"
            ...
            >
              <InputCompunent value={stateUserDetails['city']} onChange={handleOnchangeDetails} name="city" />
            </Form.Item>
            <Form.Item
              label="Phone"
              name="phone"
            ...
            >
              <InputCompunent value={stateUserDetails.phone} onChange={handleOnchangeDetails} name="phone" />
            </Form.Item>
            ...
            >
              <InputCompunent value={stateUserDetails.address} onChange={handleOnchangeDetails} name="address" />
            </Form.Item>
          </Form>
        </Loading>
      </ModalComponent >
